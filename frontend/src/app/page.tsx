  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-primary to-cyan-400 flex items-center justify-center flex-shrink-0">
      ...
      <section className="relative overflow-hidden text-center py-20 px-4 sm:py-28">
        <div className="absolute -top-48 left-1/2 -translate-x-1/2 w-[60%] h-[60%] rounded-full bg-gradient-to-tr from-primary/20 to-transparent filter blur-3xl pointer-events-none" />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
            AI-powered resume analysis that gives you an ATS match score, detects skill gaps, and rewrites your resume to pass any applicant tracking system.
          </p>
          ...
          <div className="flex justify-center gap-3 flex-wrap">
            ...
            <a href="#how" className="inline-flex items-center gap-2 text-sm font-medium text-muted-foreground px-4 py-3 rounded-full border border-border">
              See How It Works
            </a>
          </div>
          ...
          <div className="mt-8 flex items-center justify-center gap-3 flex-wrap">
            <div className="flex -space-x-2">
              {['#a78bfa', '#818cf8', '#60a5fa', '#34d399', '#f59e0b'].map((c, i) => (
                <div
                  key={i}
                  className="w-8 h-8 rounded-full border-2 border-background flex-shrink-0"
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/5 border border-primary/15 text-primary mb-4">
              <Zap size={12} className="flex-shrink-0" />
              <span className="text-sm font-medium">Features</span>
            </div>
            <h2 className="text-2xl md:text-3xl font-extrabold">
              Everything you need to <span className="bg-clip-text text-transparent bg-gradient-to-br from-purple-400 to-cyan-400">get hired</span>
            </h2>
          </div>

          <div className="grid gap-6 grid-cols-1 md:grid-cols-3">
            {features.map((f, i) => (
              <div key={i} className="p-6 rounded-2xl bg-card border border-border hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
                <div
                  className="w-12 h-12 rounded-lg mb-4 flex items-center justify-center flex-shrink-0"
      ...
      <section id="how" className="py-16 bg-primary/5">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground mb-8 leading-relaxed">Go from resume upload to AI-powered insights in under 60 seconds.</p>

          <div className="space-y-4 text-left">
            {steps.map((s, i) => (
              <div key={i} className="flex items-center gap-4 bg-card border border-border p-4 rounded-xl">
                <div
                  className="w-12 h-12 flex-shrink-0 rounded-lg flex items-center justify-center font-bold text-primary text-sm"
                  style={{ background: 'linear-gradient(135deg, rgba(124,58,237,0.14), rgba(6,182,212,0.14))' }}
                >
                  {s.step}
                </div>
      ...
      <section className="py-16 text-center">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-extrabold mb-4">
            Ready to get <span className="bg-clip-text text-transparent bg-gradient-to-br from-purple-400 to-cyan-400">hired faster?</span>
          </h2>
          <p className="text-muted-foreground mb-8 leading-relaxed">Join thousands of job seekers who have landed interviews at top companies.</p>
          <Link href="/login" className="inline-flex items-center gap-2 bg-gradient-to-br from-primary to-indigo-600 text-white px-6 py-3 rounded-full text-sm font-semibold shadow-lg">
